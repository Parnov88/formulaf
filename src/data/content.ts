export const content = {
  meta: {
    title: 'Fórmula F — Por Que Mulheres Ignoram Homens Bons?',
    description: 'A resposta está neste vídeo gratuito. Assista agora — antes que ele saia do ar.',
  },
  ...
  player: {
    windowTitle: 'Fórmula F — Aula Gratuita',
  ...
  painCards: [
    {
      icon: '📱',
      title: 'Apps que não respondem',
      text: 'Você paga o Gold, dá swipe por meia hora, e o resultado é zero match real — ou likes de bot querendo seguidor no Insta.',
    },
    {
      icon: '👻',
      title: 'Invisible ao mundo feminino',
      text: 'Você existe. Você trabalha, estuda, trata bem as pessoas. Mas pra elas, é como se você não estivesse lá. Como um fantasma.',
    },
    {
      icon: '🔇',
      title: 'O silêncio quando você chega em casa',
      text: 'Depois de um dia inteiro, você abre a porta e o silêncio é ensurdecedor. Você faz o exercício de dizer que está bem — mas você não está.',
    },
  ],
  ...
  benefits: {
    ...
    items: [
      ...
      'O checklist de 4 pontos para avançar com segurança — sem risco de constrangimento ou rejeição surpresa',
      'Os comportamentos femininos que a maioria dos homens não percebe — e que revelam quando ela está esperando você se mover',
      'Os 2 erros que colocam você direto na zona de amizade (e como evitá-los)',
      'Como criar aquele efeito "tem algo nele" que as mulheres sentem mas não conseguem explicar',
      'A diferença de abordagem entre mulheres na faixa dos 20 e acima dos 30',
      'Como reacender a atração em relacionamentos onde o fogo foi esfriando',
    ],
  },

  offer: {
    title: 'Você está levando hoje:',
    items: [
      { label: '📘 Fórmula F (Curso Principal)', price: 'R$197' },
      { label: '🎁 Bônus 1 — Método da Abertura', price: 'R$37' },
      { label: '🎁 Bônus 2 — Casos Reais', price: 'R$27' },
      { label: '🎁 Bônus 3 — Blueprint Atração', price: 'R$47' },
      { label: '🎁 Bônus 4 — Avançar Sem Assustar', price: 'R$37' },
      { label: '🎁 Bônus 5 — Linguagem Corporal', price: 'R$47' },
      { label: '🎁 Bônus 6 — Banter na Prática', price: 'R$37' },
      { label: '🎁 Bônus 7 — Entrevistas Reais', price: 'R$57' },
    ],
  ...
  guarantee: {
    ...
    text: 'Você aplica a Fórmula F por 90 dias. Se não ver mudança real na forma como as mulheres respondem a você, me manda um e-mail e eu devolvo cada centavo.',
    highlight: 'Sem perguntas. Sem burocracia. Sem julgamento. O risco é 100% nosso.',
  },
  ...
  stickyCta: {
    label: 'R$47 — Garantir Fórmula F →',
  },

  vturb: {
    accountId: '91783df2-d643-49c6-9e32-2e0ae77e8d82',
    playerId: '6a28e0e6a67c9da6bf2f3fac',
  },

  countdown: {
    durationSeconds: 23 * 3600 + 59 * 60 + 59,
    storageKey: 'formulaF_countdown_expiry',
  },
